...
for passe in ['0239', '0228', '0163','0152', '0076', '0050']: 
    ...
    # Encontrar a grade do modelo que envolve cada corrdenada contidas nas células--------------------------------------------
    ...
    # Aproximar as corrdenadas das células com base no intervalo correspondente a resolução espacial do modelo DAC (0,25°x0,25°)
    ...
    for i in range(0,(len(celulas)),1):   
        ...
        for j in range(0,len(day),1):
            ...
            clat.append(ddlat)
            clon.append(ddlong)
            cssh.append(ssh[j]+ddac) # Remover os efeitos de Barômetro Inverso
